...
def dconv3x3(in_channels, out_channels, stride=1, groups=1):
    return dconvnxn(in_channels, out_channels, kernel_size=3, stride=stride, groups=groups, padding=1)

def dconvnxn(in_channels, out_channels, kernel_size, stride=1, groups=1, padding=0):
