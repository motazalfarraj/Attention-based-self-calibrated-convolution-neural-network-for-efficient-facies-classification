...
_C.GPUS = (0,)
_C.OUTPUT_DIR = "output"  # This will be the base directory for all output, such as logs and saved ms_models
...
# size of voxel cube: WINDOW_SIZE x WINDOW_SIZE x WINDOW_SIZE; used for 3D ms_models only
_C.WINDOW_SIZE = 65
...
_C.TRAIN.MODEL_DIR = "ms_models"  # This will be a subdirectory inside OUTPUT_DIR
