...
def create_supervised_trainer(
    ...
    """Factory function for creating a trainer for supervised segmentation ms_models.
...
def create_supervised_evaluator(
    ...
    """Factory function for creating an evaluator for supervised segmentation ms_models.
